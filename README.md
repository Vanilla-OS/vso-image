...
```sh
gh attestation verify oci://ghcr.io/vanilla-os/vso:latest --owner Vanilla-OS
```

## Use of Generative AI

Maintainers may use generative AI tools as assistants while working on vso-image. Non-trivial assisted commits disclose the tool, model, and scope of the work.
